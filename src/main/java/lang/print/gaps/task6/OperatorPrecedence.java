...
public class OperatorPrecedence {
    public static void main(String[] args) {
        ...
        //Introduce changes (add brackets) to code snippets below to get expected results (for System.out.println(firstBool && secondBool || thirdBool && fourthBool || (varSix = 5) < 0);
